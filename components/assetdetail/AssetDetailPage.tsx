...
import { formatARS, formatUSD, formatDate, formatNumber } from '@/lib/formatters';
...
export function AssetDetailPage({ ticker }: AssetDetailPageProps) {
            ...
            <div className="bg-[#1a1d29] border border-[#2d3348] rounded-xl p-5">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={quantityData}>
                  ...
                  <XAxis dataKey="label" stroke="#94a3b8" tick={{ fontSize: 10 }} />
                  <YAxis stroke="#94a3b8" tick={{ fontSize: 10 }} />
                  <Tooltip contentStyle={tooltipStyle} formatter={(val) => [Number(val ?? 0), 'Cantidad']} />
