...
interface SettingsPageProps {
  ...
  onImport: (txs: Transaction[], replace?: boolean) => void;
  onClear: () => void;
  showToast: (msg: string, type?: 'success' | 'error') => void;
}

export function SettingsPage({ transactions, onImport, onClear, showToast }: SettingsPageProps) {
  ...
  const handleLoadSampleData = () => {
    const withIds = sampleTransactions.map(t => ({ ...t, id: uuidv4() }));
    onImport(withIds, false);
    showToast(`${withIds.length} operaciones de ejemplo cargadas`);
  };
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-[#1a1d29] border border-[#2d3348] rounded-xl px-6 py-4">
        ...
        <p className="text-white text-sm">
          ...
          {' '}operaciones almacenadas en el navegador
        </p>
      </div>
      ...
      <Section title="Exportar datos">
        <ActionButton
          ...
          description="Descargá todas tus operaciones como archivo JSON para hacer backup o mover a otro navegador"
        />
        <ActionButton
      ...
      <Section title="Importar datos">
        <ActionButton
          ...
          description="Cargá un archivo JSON previamente exportado. Reemplazará todos los datos actuales."
          variant="default"
        />
        ...
        <ActionButton
          ...
          description="Agrega un set de 10 operaciones de muestra para explorar la app"
          variant="default"
        />
      </Section>
      ...
      <Section title="Zona peligrosa">
        <ActionButton
          ...
          description="Elimina permanentemente todas las operaciones. Esta acción no se puede deshacer."
          variant="danger"
        />
      </Section>
